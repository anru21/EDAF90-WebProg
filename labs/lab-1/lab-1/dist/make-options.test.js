...
const make_options_1 = require("./make-options");
const inventory_1 = require("./inventory");
(0, vitest_1.test)("makeOptions({}, 'foundation')", () => {
    (0, vitest_1.expect)((0, make_options_1.makeOptions)({}, 'foundation')).toStrictEqual([]);
});
(0, vitest_1.test)("makeOptions({}, 'unknown type')", () => {
    (0, vitest_1.expect)((0, make_options_1.makeOptions)({}, 'foundation')).toStrictEqual([]);
});
(0, vitest_1.test)("makeOptions(inventory, 'foundation')", () => {
    (0, vitest_1.expect)((0, make_options_1.makeOptions)(inventory_1.inventory, 'foundation')).toStrictEqual([
...
(0, vitest_1.test)("makeOptions(inventory, 'protein')", () => {
    (0, vitest_1.expect)((0, make_options_1.makeOptions)(inventory_1.inventory, 'protein')).toStrictEqual([
...
(0, vitest_1.test)("makeOptions(inventory, 'extra')", () => {
    (0, vitest_1.expect)((0, make_options_1.makeOptions)(inventory_1.inventory, 'extra')).toStrictEqual([
...
(0, vitest_1.test)("makeOptions(inventory, 'dressing')", () => {
    (0, vitest_1.expect)((0, make_options_1.makeOptions)(inventory_1.inventory, 'dressing')).toStrictEqual([
...
//# sourceMappingURL=make-options.test.js.map